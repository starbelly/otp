...
new_type_test(is_export, 1) -> true;
new_type_test(is_export, 2) -> true;
new_type_test(is_closure, 1) -> true;
new_type_test(is_closure, 2) -> true;
...
bif(is_export, 1) -> true;
bif(is_export, 2) -> true;
bif(is_closure, 1) -> true;
bif(is_closure, 2) -> true;
