...
erlperf 'crypto:secure_compare(<<"onexxxxxxxxxxxxxxxxxxxxxxxxxxxxx">>, <<"twoxxxxxxxxxxxxxxxxxxxxxxxxxxxxx">>).' 'crypto:old_equal_const_time(<<"onexxxxxxxxxxxxxxxxxxxxxxxxxxxxx">>, <<"twoxxxxxxxxxxxxxxxxxxxxxxxxxxxxx">>).' --samples 100 --warmup 1
